...
from loader.kitti_utils import Calibration
from loader.utils import recursive_glob
from loader.augmentations import *
import random
...
class KITTIRoadLoader(data.Dataset):
    ...
    def __init__(self, root, split="train", is_transform=False, 
        ...
        if phase == 'train':
            ...
            self.calib_base = os.path.join(self.root, 'training', 'calib')
        else:
            ...
            self.calib_base = os.path.join(self.root, 'testing', 'calib')
    ...
    def get_calib(self, index):
        ...
        calib_path = os.path.join(self.calib_base, im_name_splits[0] + '_' + im_name_splits[1] + '.txt')
